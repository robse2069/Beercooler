/*
 Stimulator to automatically test the Beercooler with Robot Framework
...
void setup()
{
  ...
  pinMode(cooler_pin, INPUT);   // digital sensor is on digital pin 2
  pinMode(PWM_pin, OUTPUT);   // digital sensor is on digital pin 2
